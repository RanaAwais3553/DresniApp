...
import { intro1, logo } from '../../assets/Images'
    ...
    return (
        <View style={styles.container}>
            <View style={styles.sk_btn}>
                <Text onPress={() => props.navigation.navigate('Walkthrough2')} style={styles.sk_txt}>
                    Skip
                </Text>
            </View>

            <GestureRecognizer
                onSwipeLeft={() => props.navigation.navigate('Walkthrough2')}
                config={config}
                style={{
                    flex: 1,
                }}
            >
                ...
                <View>
                    <Image style={styles.wk_image} source={intro1} />

                    <View style={styles.wk_info}>
                        <Text style={styles.wk_txt1}>NEED HELP RIGHT</Text>

                        <Text style={styles.wk_txt2}>
                            Daresni is a web and application based platform, founded in 2018 that connects students & tutors in order to build a better future where private education is accessible to everyone!
                        </Text>
                    </View>

                    <View style={styles.pgPattern}>
                        <View style={styles.ptActive} />
