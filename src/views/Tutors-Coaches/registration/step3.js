...
const TutorRegStep3 = (props) => {
    ...
    const _navigate = async () => {
        ...
        if (!tlanuagesError && !expertiseError && !teachingSubjectsError && !teachModeError && !pricingError && !profilePhotoError) {
            ...
            props.navigation.navigate("TutorRegStep4", { registrationObj })
